...
//   return (
//     <section id="contact" className="relative py-20 bg-[#0a1628] overflow-hidden" style={{
//   background: `
...
//           <div className="text-center bg-[#0f1d33]/50 border border-[#d4af37]/30 rounded-lg p-8 hover:border-[#d4af37] transition-all duration-300">
...
//             </div>
//             <h3 className="text-xl font-serif text-[#f5f5dc] mb-2">Visit us at</h3>
//             <p className="text-[#d4af37] text-lg">Leander, Texas</p>
//           </div>
//         </div>
...
// URL for the Google Maps iframe embed - UPDATED
const googleMapsEmbedUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d194.3474532618727!2d-97.79164686274096!3d30.5443642471198!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x865b2d624e0ddd25%3A0xf542405fa38e011e!2sHYDERABADI%20SPICY%20MATKA%20-%20LEANDER%20-%20INDIAN%20CUISINE!5e0!3m2!1sen!2sin!4v1760984697170!5m2!1sen!2sin";

// Direct link to the location on Google Maps - UPDATED
const googleMapsDirectUrl = "https://www.google.com/maps/place/HYDERABADI+SPICY+MATKA+-+LEANDER+-+INDIAN+CUISINE/@30.5443906,-97.791667,19z/data=!4m6!3m5!1s0x865b2d624e0ddd25:0xf542405fa38e011e!8m2!3d30.5443906!4d-97.791667!16s%2Fg%2F11v0w_z9px?entry=ttu";

export default function ContactPage() {
  return (
    <section id="contact" className="relative py-24 sm:py-32 overflow-hidden" style={{
  background: `
    /* Layer 1 (Top): Soft vignette */
    linear-gradient(
      to right,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center bg-[#0f1d33]/50 border border-[#d4af37]/30 rounded-lg p-8 transform hover:-translate-y-2 transition-all duration-300">
            <div className="flex justify-center mb-4"><Mail className="text-[#d4af37]" size={40} /></div>
            <h3 className="text-xl font-serif text-[#f5f5dc] mb-2">Mail us at</h3>
            <a href="mailto:Hsmaustin.Leander@gmail.com" className="text-[#d4af37] hover:text-[#e6c158] transition-colors text-lg">Hsmaustin.Leander@gmail.com</a>
          </div>

          {/* Phone Card */}
          <div className="text-center bg-[#0f1d33]/50 border border-[#d4af37]/30 rounded-lg p-8 transform hover:-translate-y-2 transition-all duration-300">
            <div className="flex justify-center mb-4"><Phone className="text-[#d4af37]" size={40} /></div>
            <h3 className="text-xl font-serif text-[#f5f5dc] mb-2">Call us at</h3>
            <a href="tel:+17373406589" className="text-[#d4af37] hover:text-[#e6c158] transition-colors text-lg">+1 737-340-6589</a>
          </div>

          {/* Address Card */}
          <div className="text-center bg-[#0f1d33]/50 border border-[#d4af37]/30 rounded-lg p-8 transform hover:-translate-y-2 transition-all duration-300">
            <div className="flex justify-center mb-4"><MapPin className="text-[#d4af37]" size={40} /></div>
            <h3 className="text-xl font-serif text-[#f5f5dc] mb-2">Visit us at</h3>
            <p className="text-[#d4af37] text-lg leading-relaxed">13920 Ronald Reagan Blvd,<br/>Suite 100, Leander, TX 78641</p>
          </div>
        </div>

        {/* ====== Google Maps Section ====== */}
        <div className="my-24">
          <h3 className="text-4xl font-serif text-center font-bold text-[#d4af37] mb-8">Find Us Here</h3>
          <a 
          ...
          >
            {/* The pointer-events-none class is crucial. It makes the iframe "unclickable" 
                so the click registers on the parent <a> tag, opening the link. */}
            <iframe
        ...
        <div className="max-w-4xl mx-auto bg-[#0f1d33]/70 border border-[#d4af37]/40 rounded-lg p-10 text-center">
          <div className="flex justify-center mb-6"><ChefHat className="text-[#d4af37]" size={56} /></div>
          <h3 className="text-4xl font-serif font-bold text-[#d4af37] mb-4">Exquisite Catering Services</h3>
          <p className="text-xl text-[#f5f5dc] mb-6 leading-relaxed">
            Elevate your events with the unforgettable flavors of Hyderabad. From intimate gatherings to grand celebrations, our expert catering team brings authentic taste and impeccable service to your special occasions.
          </p>
          <p className="text-lg text-[#f5f5dc] mb-4">Contact us for Live Catering:</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="tel:+17373406589" className="text-[#d4af37] hover:text-[#e6c158] transition-colors text-xl font-semibold">+1 737-340-6589</a>
            <span className="hidden sm:inline text-[#d4af37]">|</span>
            <a href="mailto:Hsmaustin.Leander@gmail.com" className="text-[#d4af37] hover:text-[#e6c158] transition-colors text-xl font-semibold">Hsmaustin.Leander@gmail.com</a>
          </div>
        </div>
      </div>
    </section>
